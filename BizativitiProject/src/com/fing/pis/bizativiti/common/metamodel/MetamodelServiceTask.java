...
public class MetamodelServiceTask extends MetamodelTask {

    public MetamodelServiceTask(String id, String name, String description, double x, double y, double width,
