...
public abstract class MetamodelFlowElement extends MetamodelElement {
    ...
    public MetamodelFlowElement(String id, String name, String description, double x, double y, double width,
            double height) {
        super(id, description);
        if (name == null) {
            throw new IllegalArgumentException("name value can't be null");
        }
        this.name = name;
        if (x == -1) {
