...
public class ParallelGatewayTranslator extends ATranslator {

    @Override
    public JAXBElement<? extends TFlowElement> getFlowElement(Object o, TranslatorState e) {
        MetamodelParallelGateway element = (MetamodelParallelGateway) o;
        ...
        return e.getModelFactory().createParallelGateway(gate);
    }
